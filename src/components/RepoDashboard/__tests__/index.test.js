...
const mockResponse = [
  ...
  },
  {
    ...
    "description": "A JavaScript plugin to place social buttons on a page on user interaction (mouseover) to spare the initial page load from the 300kb+ download requests for social APIs.",
    "fork": false,
    ...
    "keys_url": "https://api.github.com/repos/godaddy/lazy-social-buttons/keys{/key_id}",
    "collaborators_url": "https://api.github.com/repos/godaddy/lazy-social-buttons/collaborators{/collaborator}",
    ...
    "issue_events_url": "https://api.github.com/repos/godaddy/lazy-social-buttons/issues/events{/number}",
    "events_url": "https://api.github.com/repos/godaddy/lazy-social-buttons/events",
    "assignees_url": "https://api.github.com/repos/godaddy/lazy-social-buttons/assignees{/user}",
    "branches_url": "https://api.github.com/repos/godaddy/lazy-social-buttons/branches{/branch}",
    "tags_url": "https://api.github.com/repos/godaddy/lazy-social-buttons/tags",
    "blobs_url": "https://api.github.com/repos/godaddy/lazy-social-buttons/git/blobs{/sha}",
    "git_tags_url": "https://api.github.com/repos/godaddy/lazy-social-buttons/git/tags{/sha}",
    "git_refs_url": "https://api.github.com/repos/godaddy/lazy-social-buttons/git/refs{/sha}",
    "trees_url": "https://api.github.com/repos/godaddy/lazy-social-buttons/git/trees{/sha}",
    "statuses_url": "https://api.github.com/repos/godaddy/lazy-social-buttons/statuses/{sha}",
    "languages_url": "https://api.github.com/repos/godaddy/lazy-social-buttons/languages",
    "stargazers_url": "https://api.github.com/repos/godaddy/lazy-social-buttons/stargazers",
    "contributors_url": "https://api.github.com/repos/godaddy/lazy-social-buttons/contributors",
    "subscribers_url": "https://api.github.com/repos/godaddy/lazy-social-buttons/subscribers",
    "subscription_url": "https://api.github.com/repos/godaddy/lazy-social-buttons/subscription",
    "commits_url": "https://api.github.com/repos/godaddy/lazy-social-buttons/commits{/sha}",
    "git_commits_url": "https://api.github.com/repos/godaddy/lazy-social-buttons/git/commits{/sha}",
    "comments_url": "https://api.github.com/repos/godaddy/lazy-social-buttons/comments{/number}",
    "issue_comment_url": "https://api.github.com/repos/godaddy/lazy-social-buttons/issues/comments{/number}",
    "contents_url": "https://api.github.com/repos/godaddy/lazy-social-buttons/contents/{+path}",
    "compare_url": "https://api.github.com/repos/godaddy/lazy-social-buttons/compare/{base}...{head}",
    "merges_url": "https://api.github.com/repos/godaddy/lazy-social-buttons/merges",
    "archive_url": "https://api.github.com/repos/godaddy/lazy-social-buttons/{archive_format}{/ref}",
    "downloads_url": "https://api.github.com/repos/godaddy/lazy-social-buttons/downloads",
    "issues_url": "https://api.github.com/repos/godaddy/lazy-social-buttons/issues{/number}",
    "pulls_url": "https://api.github.com/repos/godaddy/lazy-social-buttons/pulls{/number}",
    "milestones_url": "https://api.github.com/repos/godaddy/lazy-social-buttons/milestones{/number}",
    "notifications_url": "https://api.github.com/repos/godaddy/lazy-social-buttons/notifications{?since,all,participating}",
    "labels_url": "https://api.github.com/repos/godaddy/lazy-social-buttons/labels{/name}",
    "releases_url": "https://api.github.com/repos/godaddy/lazy-social-buttons/releases{/id}",
    "deployments_url": "https://api.github.com/repos/godaddy/lazy-social-buttons/deployments",
...
test('render repo dashboard with mock data', async() => {
  const { getByText } = await render(<Repo />);
  await waitFor(() => expect(getByText('gdapi-php')).toBeInTheDocument());
})